...
@section("content")
<section id="term-of-service" class="l-content-fixed section">
    ...
    <div class="desc-container mt-5">
        ...
        <p class="text-left">
            (1) 当社は、お客様から、個人情報が真実でないという理由によって、個人情報保護法の定めに 基づきその内容の訂正、追加又は削
            ...
            令により、当社が訂正等の義務を負わない場合は、この限りではありません。<br>
            (2)
